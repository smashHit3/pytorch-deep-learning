...
from .mobilenet import MobileNet, mobilenet, mobilenet_0_5, mobilenet_0_75, MODEL_TYPE_MOBILENET
...
__all__ = [
    ...
    'MobileNet', 'mobilenet', 'mobilenet_0_5', 'mobilenet_0_75', 'MODEL_TYPE_MOBILENET',
]