...
from cv_sources.models.alexnet import AlexNet, MODEL_TYPE_ALEXNET
...
from cv_sources.models.googlenet import GoogleNet, MODEL_TYPE_GOOGLENET
...
from cv_sources.models.mobilenet import MobileNet, mobilenet_1_0, mobilenet_0_5, mobilenet_0_75, MODEL_TYPE_MOBILENET_1_0, MODEL_TYPE_MOBILENET_0_5, MODEL_TYPE_MOBILENET_0_75
