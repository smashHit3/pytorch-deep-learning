...
train_concise(wd=0)  # No weight decay
train_concise(wd=3)  # With weight decay
train_concise(wd=5)  # With larger weight decay
train_concise(wd=7)  # With even larger weight decay
plt.show()