...
@File: gru.py
@Description: GRU implementation for text classification following PyTorch official best practices
"""
...
class GRUClassifier(nn.Module):
    """
    GRU-based text classifier following PyTorch official best practices.
    ...
    def init_weights(self) -> None:
        ...
        # Initialize GRU weights following PyTorch official init
    ...
    def forward(self, x: torch.Tensor, lengths: Optional[torch.Tensor] = None) -> torch.Tensor:
        """
        Forward pass through the GRU classifier.
        ...
        _, hidden = self.gru(packed_embeds)  # hidden: (num_layers * num_directions, batch_size, hidden_dim)
...
def gru_classifier(vocab_size: int = 10000, embedding_dim: int = 128, hidden_dim: int = 256,
                  num_classes: int = 2, num_layers: int = 2, dropout: float = 0.5, 
                  bidirectional: bool = True, padding_idx: int = 0, **kwargs) -> GRUClassifier:
    """
    Factory function for creating GRUClassifier instances.
    
    Args:
        vocab_size: Size of vocabulary (default: 10000)
        embedding_dim: Dimension of word embeddings (default: 128)
        hidden_dim: Dimension of GRU hidden states (default: 256)
